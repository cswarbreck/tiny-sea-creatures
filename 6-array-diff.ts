...
const arr1: number[] = [60,85,28,75,46,84,89,95,29,45,61,41,77,74,37,23,62,75,80,29,28,18,31,30,92,24,70,17,24,42,16,39];
const arr2: number[] = [95,56,50,8,44,60];
